...
let selectedAPIs = JSON.parse(
  localStorage.getItem('selectedAPIs') || 
  '["tyyszy","dyttzy","bfzy","ruyi","ffzy","zy360","iqiyi","wolong","ysgc","wlzy","hwba","jisu","dbzy","wjzy","zuid","mdzy","sdzy","tkzy","fszy","hnzy","kczy","ftys","qqzy","wwzy","baidu","wujin","wwzy","ikun"]'
); // 默认选中资源
